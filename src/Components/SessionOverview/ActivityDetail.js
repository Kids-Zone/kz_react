...
const ActivityDetail = (props) => {
  ...
  const jumbotronStyle = {
      backgroundImage: 'linear-gradient(rgba(0,0,0,.65),rgba(0,0,0,.1)), url(/images/' + activity.id + '.jpg)',
  ...
  return (
    <div>
      <div class="jumbotron container-fluid" style={jumbotronStyle}>
        <div class="container">
          <h1 class="display-3 text-white" style={{ textTransform:'uppercase', letterSpacing: '.2em'}}>{activity.title}</h1>
        </div>
      </div>
